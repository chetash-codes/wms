...
namespace WMS.Infrastructure.Migrations
{
    ...
    [Migration("20260608214033_MakeAuditLogCreatedByNullable")]
    partial class MakeAuditLogCreatedByNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 3,
                            Description = "Standard User Staff",
                            RoleName = "Employee"
                        });
                });
            ...
            modelBuilder.Entity("WMS.Domain.Entities.AuditLog", b =>
                {
                    b.HasOne("WMS.Domain.Entities.Employee", "User")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
